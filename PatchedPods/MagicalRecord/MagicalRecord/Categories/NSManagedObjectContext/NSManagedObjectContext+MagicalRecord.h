...
/**
 Context für das Binden von FetchControllern. Er läuft nicht auf dem Mainthread und wird aber über änderungen informiert
 */
+ (MR_nonnull NSManagedObjectContext *) MR_backgroundFetchContext;
...
-(void)performBlockAndWait:(void (^ _Nullable)(void))block  rethrowExceptions:(BOOL)rethrow;
