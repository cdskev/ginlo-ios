...
class SharingHelper {
    ...
    func showSharingForInvitation(fromViewController viewController: UIViewController?, sourceView: UIView? = nil, sourceRect: CGRect? = nil, barButtonItem: UIBarButtonItem? = nil) {
        ...
        if DPAGApplicationFacade.preferences.isBaMandant == false, let account = DPAGApplicationFacade.cache.account, let qrCodeLink = DPAGApplicationFacade.contactsWorker.qrCodeContent(account: account, version: .v3) {
            do {
