// This is a generated source file for Chilkat version 9.5.0.54
...
CK_VISIBLE_PUBLIC BOOL CkOmaDrmW_getLastMethodSuccess(HCkOmaDrmW cHandle);
CK_VISIBLE_PUBLIC void CkOmaDrmW_putLastMethodSuccess(HCkOmaDrmW cHandle, BOOL newVal);
