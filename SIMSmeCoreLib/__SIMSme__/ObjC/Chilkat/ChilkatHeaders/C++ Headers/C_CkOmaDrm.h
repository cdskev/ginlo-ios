...
CK_VISIBLE_PUBLIC BOOL CkOmaDrm_getLastMethodSuccess(HCkOmaDrm cHandle);
CK_VISIBLE_PUBLIC void CkOmaDrm_putLastMethodSuccess(HCkOmaDrm cHandle, BOOL newVal);
