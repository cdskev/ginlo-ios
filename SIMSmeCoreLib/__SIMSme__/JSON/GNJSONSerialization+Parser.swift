...
internal struct GNJSONParser {
    ...
    mutating func parse() throws -> GNJSONValue {
    ...
    mutating func parseValue() throws -> GNJSONValue {
        var whitespace = 0
