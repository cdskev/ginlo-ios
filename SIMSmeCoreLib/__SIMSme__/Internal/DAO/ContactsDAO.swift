...
class ContactsDAO: ContactsDAOProtocol {
    ...
    func saveContact(contact: DPAGContactEdit) {
        DPAGApplicationFacade.persistance.saveWithBlock { localContext in
            ...
            // TODO: This needs to be deleted when proper implementation of replacing account is done in backend
            self.deleteDuplicates(contact: contact, context: localContext)
        }
    }
